...
class NTM(nn.Module):
    ...
    def __init__(self, num_inputs, num_outputs, controller, memory, heads, device=None):
        """Initialize the NTM.
        ...
        for head in heads:
            if head.is_read_head():
                init_r_bias = torch.randn(1, self.M).to(device) * 0.01
    ...
    def forward(self, x, prev_state):
        ...
        o = self.fc(inp2)  # NOTE: we will apply sigmoid on trainer.py
